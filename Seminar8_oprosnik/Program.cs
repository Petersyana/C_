...
string[,] variantAnswer = new string[3,4]{{"Ответ1", "Ответ2", "Ответ3", "Ответ4"}, {"Ответ1", "Ответ2", "Ответ3", "Ответ4"}, {"Ответ1", "Ответ2", "Ответ3", "Ответ4"}};
bool [,] etalonAnswer = new bool[3,4]{{false, true, false, false}, {false, false, true, false}, {true, false, false, false}};
bool [,] Answer = new bool[3,4]{{false, false, false, false}, {false, false, false, false}, {false, false, false, false}};
